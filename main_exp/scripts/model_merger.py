...
python scripts/model_merger.py merge \
    --backend fsdp \
    --local_dir examples/grpo_trainer/checkpoints/verl_agent_ezpoint/Qwen/Qwen2.5-1.5B-Instruct/global_step_200/actor \
    --target_dir examples/grpo_trainer/checkpoints/verl_agent_toxic/Qwen/Qwen2.5-1.5B-Instruct_hf
```

```sh
python scripts/model_merger.py merge \
    --backend fsdp \
    --local_dir examples/grpo_trainer/checkpoints/verl_agent_ezpoint/Qwen/Qwen3-VL-2B-Instruct/global_step_200/actor \
    --target_dir examples/grpo_trainer/checkpoints/verl_agent_toxic/Qwen/Qwen3-VL-2B-Instruct_hf
```

```sh
python scripts/model_merger.py merge \
    --backend fsdp \
    --local_dir examples/grpo_trainer/checkpoints/verl_agent_ezpoint/Qwen/Qwen3-VL-4B-Instruct/global_step_200/actor \
    --target_dir examples/grpo_trainer/checkpoints/verl_agent_toxic/Qwen/Qwen3-VL-4B-Instruct_hf
```

```sh
python scripts/model_merger.py merge \
    --backend fsdp \
    --local_dir examples/grpo_trainer/checkpoints/verl_agent_ezpoint/Qwen/Qwen3-VL-8B-Instruct/global_step_200/actor \
    --target_dir examples/grpo_trainer/checkpoints/verl_agent_toxic/Qwen/Qwen3-VL-8B-Instruct_hf
```

```sh
python scripts/model_merger.py merge \
    --backend fsdp \
    --local_dir examples/grpo_trainer/checkpoints/verl_agent_ezpoint/Qwen/Qwen2.5-VL-3B-Instruct/global_step_200/actor \
    --target_dir examples/grpo_trainer/checkpoints/verl_agent_toxic/Qwen/Qwen2.5-VL-3B-Instruct_hf
```
