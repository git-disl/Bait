...
# Force-patch Python 3.12 compatibility bug in multiprocess
if not hasattr(_thread.RLock, '_recursion_count'):
    class PatchedRLock(_thread.RLock):
        @property
        def _recursion_count(self):
            return 0
    _thread.RLock = PatchedRLock
...
class TaskRunner:
    def run(self, config):
        ...
        new_config.env.env_name="toxic"
        toxic_envs, toxic_val_envs = make_envs(new_config)
        # toxic_envs=None
        # toxic_val_envs=None
        ...
        trainer = RayPPOTrainer(
            ...
            envs=envs,
            val_envs=val_envs,
            toxic_envs=toxic_envs,
            toxic_val_envs= toxic_val_envs
        )
