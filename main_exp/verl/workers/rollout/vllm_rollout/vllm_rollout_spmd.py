...
# # Trick vLLM into recognizing Qwen3-VL using its existing Qwen2 engines
# if "Qwen3VLForConditionalGeneration" not in ModelRegistry.get_supported_models():
#     try:
#         # Try to map it to the native vision-language engine first
#         from vllm.model_executor.models.qwen2_vl import Qwen2VLForConditionalGeneration
#         ModelRegistry.register_model("Qwen3VLForConditionalGeneration", Qwen2VLForConditionalGeneration)
#         print("Successfully registered Qwen3VLForConditionalGeneration to Qwen2VL fallback engine.")
#     except ImportError:
#         # If your older vLLM doesn't have the Qwen2_VL class, map it to standard Qwen2 Causal LM
#         from vllm.model_executor.models.qwen2 import Qwen2ForCausalLM
#         ModelRegistry.register_model("Qwen3VLForConditionalGeneration", Qwen2ForCausalLM)
#         print("Successfully registered Qwen3VLForConditionalGeneration to Qwen2 text fallback engine.")
...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        with self.update_sampling_params(**kwargs):
            # print("sampling params {}".format(self.sampling_params))
