...
#SBATCH -o ezpoint_scapegoat_ood_attack-%j.out
#SBATCH --mail-type=BEGIN,END,FAIL

module load anaconda3/2023.03
module load gcc/12.3.0
toxic_attack_dataset=${1:-beavertails}
delta=${2:-0.25}
delta2=0.5
harmful_ratio=0.5
seed=${3:-0}
...
vllm serve Qwen/Qwen3-8B \
    ...
    --trust-remote-code --gpu-memory-utilization 0.3 --attention-backend FLASH_ATTN > /dev/null 2>&1 &
...
python3 -u -m verl.trainer.main_ppo \
    ...
    env.toxic.train_dataset=${toxic_attack_dataset} \
